...
/// faster transport (i.e. dev mode `flet run` over UDS/TCP). Allocates a
/// monotonic 32-bit id per channel and ships frames as
/// `[0x01][channel_id:u32 LE][payload]` over the active
/// [FletBackendChannel] alongside regular Flet protocol traffic.
///
