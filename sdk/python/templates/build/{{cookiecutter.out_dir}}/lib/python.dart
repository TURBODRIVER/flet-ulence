...
# stderr (desktop).
# Tee here so the error-screen capture file ALSO gets the output.
...
#
# We keep `_exit_port` in a one-element list so the session-restart handler
# below can mutate it in place — `flet_exit` always reads the current value.
