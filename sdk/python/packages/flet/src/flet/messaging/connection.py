...
class Connection:
    ...
    socket messaging) and must implement message sending and platform-specific
    service methods.
    """
    ...
    # channel = a dedicated PythonBridge port), socket mode (channel frames
    # muxed over the same protocol transport).
    # ------------------------------------------------------------------
