...
class GradientTileMode(str, Enum):
    ...
    [here](https://api.flutter.dev/flutter/dart-ui/TileMode.html).
    """

    CLAMP = "clamp"
    """
    Samples beyond the edge are clamped to the nearest color in the defined inner \
    area.
    More information
    [here](https://api.flutter.dev/flutter/dart-ui/TileMode.html#clamp).
    """
    ...
    More information
    [here](https://api.flutter.dev/flutter/dart-ui/TileMode.html#decal).
    """
    ...
    More information
    [here](https://api.flutter.dev/flutter/dart-ui/TileMode.html#mirror).
    """
    ...
    More information
    [here](https://api.flutter.dev/flutter/dart-ui/TileMode.html#repeated).
    """
...
class RadialGradient(Gradient):
    ...
    the paint box. For example, if a radial gradient is painted on a box that is \
    `100.0` pixels wide and `200.0` pixels tall, then a radius of `1.0` will place the \
    `1.0` stop at `100.0` pixels from the focal point.
    """
...
class SweepGradient(Gradient):
    ...
    """
    The angle in [radians](https://en.wikipedia.org/wiki/Radian) at which stop `0.0` \
    of the gradient is placed.
    """

    end_angle: Number = math.pi * 2
    """
    The angle in [radians](https://en.wikipedia.org/wiki/Radian) at which stop `1.0` \
    of the gradient is placed.
    """
