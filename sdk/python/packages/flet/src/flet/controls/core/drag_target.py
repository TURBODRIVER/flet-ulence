...
class DragTargetEvent(Event["DragTarget"]):
    ...
    @deprecated(
        ...
        docs_reason="Use [`local_position.x`][flet.DragTargetEvent.local_position] for target-relative coordinates or "
        "[`global_position.x`][flet.DragTargetEvent.global_position] for global coordinates instead.",
        version="0.85.0",
    ...
    @deprecated(
        ...
        docs_reason="Use [`local_position.y`][flet.DragTargetEvent.local_position] for target-relative coordinates or "
        "[`global_position.y`][flet.DragTargetEvent.global_position] for global coordinates instead.",
        version="0.85.0",
        delete_version="0.88.0",
    )
    def y(self) -> float:
    ...
    @deprecated(
        ...
        docs_reason="Use [`local_position`][flet.DragTargetEvent.local_position] for target-relative coordinates or "
        "[`global_position`][flet.DragTargetEvent.global_position] for global coordinates instead.",
        version="0.85.0",
        delete_version="0.88.0",
    )
