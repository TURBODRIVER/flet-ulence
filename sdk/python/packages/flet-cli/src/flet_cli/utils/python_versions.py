...
is defined by python-build's date-keyed ``manifest.json``, the single source
of truth shared with serious_python. This module pins one python-build
release date and fetches that release's manifest (cached under
